...
The reply hand is `fonts/PingFangShiGuang.ttf`, a mixed Chinese/Latin
handwriting face used for the Chinese demo. Keep a copy of the font source and
license notes with any redistributed build; commercial use should be confirmed
with the font author.
